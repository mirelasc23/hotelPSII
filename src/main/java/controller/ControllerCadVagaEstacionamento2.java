...
public class ControllerCadVagaEstacionamento2 implements ActionListener{
        CadastroVagaEstacionamento telaCadastroVagaEstacionamento;

    public ControllerCadVagaEstacionamento2(CadastroVagaEstacionamento telaCadastroVagaEstacionamento) {
