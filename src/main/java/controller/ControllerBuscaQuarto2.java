...
public class ControllerBuscaQuarto2 implements ActionListener{
    private BuscaQuarto telaBuscaQuarto;

    public ControllerBuscaQuarto2(BuscaQuarto telaBuscaQuarto) {
    ...
    public void actionPerformed(ActionEvent evento) {
        if(evento.getSource() == this.telaBuscaQuarto.getjButtonCarregar()){
            ...
            if(telaBuscaQuarto.getjTableDados().getRowCount() == 0){
                ...
                ControllerMovimentoCheck.codigo = (int)this.telaBuscaQuarto.getjTableDados().getValueAt(this.telaBuscaQuarto.getjTableDados().getSelectedRow(), 0);
