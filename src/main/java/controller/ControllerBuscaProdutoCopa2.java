...
public class ControllerBuscaProdutoCopa2 implements ActionListener{
    private BuscaProdutoCopa telaBuscaProdutoCopa;

    public ControllerBuscaProdutoCopa2(BuscaProdutoCopa telaBuscaProdutoCopa) {
    ...
    public void actionPerformed(ActionEvent evento) {
        if(evento.getSource() == this.telaBuscaProdutoCopa.getjButtonCarregar()){
            ...
            if(telaBuscaProdutoCopa.getjTableDados().getRowCount() == 0){
                ...
                ControllerMovimentoCheck.codigo = (int)this.telaBuscaProdutoCopa.getjTableDados().getValueAt(this.telaBuscaProdutoCopa.getjTableDados().getSelectedRow(), 0);
