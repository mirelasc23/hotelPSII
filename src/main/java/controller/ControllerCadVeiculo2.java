...
public class ControllerCadVeiculo2 implements ActionListener{
        CadastroVeiculo telaCadastroVeiculo;

    public ControllerCadVeiculo2(CadastroVeiculo telaCadastroVeiculo) {
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == this.telaCadastroVeiculo.getjButtonNovo()){
            ...
            if(telaCadastroVeiculo.getjTableDados().getRowCount() == 0){
                ...
                ControllerMovimentoCheck.codigo = (int)this.telaCadastroVeiculo.getjTableDados().getValueAt(this.telaCadastroVeiculo.getjTableDados().getSelectedRow(), 0);
