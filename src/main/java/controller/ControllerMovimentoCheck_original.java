...
public class ControllerMovimentoCheck_original implements ActionListener, MouseListener, KeyListener{
    MovimentoCheck telaMovimentoCheck;
    public static int codigo;
    public static float total;
    public static List<Quarto> quartos;

    public ControllerMovimentoCheck_original(MovimentoCheck telaMovimentoCheck) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == this.telaMovimentoCheck.getjButtonNovo()) {
            ...
            try {
                ...
                Logger.getLogger(ControllerMovimentoCheck_original.class.getName()).log(Level.SEVERE, null, ex);
            }
