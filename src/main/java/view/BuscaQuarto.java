 ...
 * @author aluno
 */
public class BuscaQuarto extends javax.swing.JDialog {

    /**
     * Creates new form TemplateBuscas2025
     */
    public BuscaQuarto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Identificacao", "Capacidade", "Metragem"
            }
        ));
        ...
        jComboBoxFiltrarPor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "Identificação", "Capacidade", "Metragem", "Status" }));
                ...
                .addGroup(jPanelBotoesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelBotoesLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelBotoesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanelBotoesLayout.createSequentialGroup()
                                .addComponent(jTextFieldValor, javax.swing.GroupLayout.DEFAULT_SIZE, 478, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BuscaQuarto dialog = new BuscaQuarto(new javax.swing.JFrame(), true);
