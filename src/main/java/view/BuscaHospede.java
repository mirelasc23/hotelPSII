 ...
 * @author aluno
 */
public class BuscaHospede extends javax.swing.JDialog {

    /**
     * Creates new form TemplateBuscas2025
     */
    public BuscaHospede(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaHospede.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BuscaHospede dialog = new BuscaHospede(new javax.swing.JFrame(), true);
